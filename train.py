...
@author: Priyanshi Gupta, Vathepalli Vamsi Bushan, Raj Thakkar
"""
...
supported_models = ["SmallerVGGNet", "VGG16", "InceptionV3", "Xception", "ResNet"]

if args["model"] not in supported_models:
    raise AssertionError("The --model command line argument should be from 'SmallerVGGNet','VGG16','InceptionV3','ResNet'")
...
print("Img dimensions are:", IMAGE_DIMS)
...
if args["model"] == "ResNet":
    ...
    resNet = ResNet()
    model = resNet.ResNet50(input_shape=(IMAGE_DIMS[1], IMAGE_DIMS[0], IMAGE_DIMS[2]), classes=len(lb.classes_))
...
checkpoint = ModelCheckpoint(args["model_file"], monitor='val_acc', verbose=1, save_best_only=True,
